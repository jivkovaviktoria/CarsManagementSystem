    ...
    return (
        <tr>
            ...
            <td className="actions">
                <button className="btn edit-btn" title="Edit" onClick={() => props.onClick(props.car.id, carActions.Edit)}>
                ...
                <button className="btn delete-btn" title="Delete" onClick={() => props.onClick(props.car.id, carActions.Delete)}>
                ...
                <button className="btn info-btn" title="Info" onClick={() => props.onClick(props.car.id, carActions.Info)} >
